...
<html>
    ...
    <body style="font-family: Arial, Helvetica, sans-serif; Background-image:url('bbg3.jpg'); background-attachment:fixed;">
        <div ><img src="logo.png" id="logo" style="height: 100px !important; MARIGIN-LEFT:20PX !important; margin-top: 10px !important;" ></div>
        ...
        <div class="container text-center p-3" style="background-color: rgba(255, 255, 255, 0.7); margin-top: 20px; border-radius: 15px; width: 35%;">
            ...
            <img src="userlogo.png" style="margin:0 auto; height: 140px; width: 140px; margin-bottom: 15px;">
