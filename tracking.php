<?php 
    ...
    if(isset($_POST['update'])){
        ...
        elseif($checked == 'dispatched'){
            $sql = "UPDATE status SET dispatched =CURRENT_TIMESTAMP WHERE trackingid='$inp_tid' ";
        }
                            ...
                            <div class="col-8 p-4 " style="background-color: rgba(255, 255, 255, 0.7); margin-top: 20px; ">
                                ...
                                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" class="form">
                                    <div class="form-group">
                                        ...
                                        <label><?php echo $_SESSION['up_tid'] ?? $status['rackingID']??'' ; ?></label>
                                    </div>
                                    <div class="form-group">
    ...
    <body style="font-family: Arial, Helvetica, sans-serif;">
        ...
        <div class="container mt-10">
            <div class="row">
                <div class="col-md-4 p-4 text-center pt-0" style="background-color: rgba(255, 255, 255, 0.7); margin-top: 20px;">
                    <img src="track3.png" style="margin:0 auto; height: 250px;">
                    <form action="" method="POST" class="form">
                        <div class="form-group">
                            <label style="font-size: 20px;">Tracking ID : </label>
                ...
                <div class="col-md-8 p-4 " style="background-color: rgba(255, 255, 255, 0.7); margin-top: 20px;">
                    ...
                    <div class="track bg-info">
                        ...
                        <div class="step <?php echo $status['shipped']; ?>"> <span class="icon"> <i class="fa fa-truck"></i> </span> <span class="text font-weight-bold"> On the way </span><span><?php echo $status['shipped'];?></span> </div>
                        <div class="step <?php echo $status['out_for_delivery']; ?>"> <span class="icon"> <i class="fa fa-cubes"></i> </span> <span class="text font-weight-bold"> Out for delivery </span><span><?php echo $status['out_for_delivery'];?></span> </div>
                        <div class="step <?php echo $status['delivered']; ?>"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text font-weight-bold">Delivered</span><span><?php echo $status['delivered'];?></span> </div>
                    </div>
                    <div <?php echo $hide; ?>>
                        <br>
        ...
        <div class="container-fluid text-center mt-5" style="background-color: rgba(255, 255, 255, 0.7); padding: 20px; position: relative;">
            <div class="i-bar" style="display: flex; flex-direction: row; flex-wrap: wrap; justify-content:center; margin-bottom: 2em;">
                <a class="fa fa-facebook " href="#" style="border: none; text-decoration: none;  margin: 0em 1em; color:black; font-size: xx-large;"></a>
                <a class="fa fa-instagram" href="#" style="border: none; text-decoration: none;  margin: 0em 1em; color:black; font-size: xx-large;"></a>
                <a class="fa fa-envelope " href="menagraman18@gamil.com" style="border: none; text-decoration: none;  margin: 0em 1em; color:black; font-size: xx-large;"></a>
            </div>
            <p class="credit" style="font-size: 20px; font-stretch: 3px; text-align: center; color: black;">© MAR COURIERS</p>
        </div>
    </body>
